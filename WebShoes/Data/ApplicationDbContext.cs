...
using System.Text;
using WebShoes.Configurations;
using WebShoes.Data.DataSeeding;
using WebShoes.Entity;

namespace WebShoes.Data
{
    public class ApplicationDbContext : IdentityDbContext
    {
        ...
        public DbSet<WebShoes.Models.UserInRoleModel> UserInRoleModel { get; set; }
